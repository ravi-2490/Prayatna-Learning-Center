...
const SwipesItems = [
  ...
  },
  {
    ...
    content:
      "Easily explaining all the points and they behaving like home people, they solve the problems about studying, finally good teaching mam and Sir Thank you so much Maam and Sir 🙏🙏🙏",
  },
  // {
  //   name: "Nisanth",
  ...
  },
  {
    ...
    content:
      "I am a student of prayatna tuition (PCME -class12/ SJPUC) Ashwin sir and Deepshikha ma’am are just Brilliant in their work and the way they teach ! They are down to earth and there is no hierarchical setup but indeed they provide one to one coaching.",
  },
];
