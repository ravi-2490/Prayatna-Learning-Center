...
import TestimonialImageSix from "../../../public/images/testimonial/6.jpg";
...
const SwipesItems = [
  ...
  {
    name: "Nishanth Bodapati",
    image: TestimonialImageFour,
    content:
      "I am a student of prayatna tution (PCME -class12/ SJPUC) Ashwin sir and Deepshikha ma’am are just Brilliant in their work and the way they teach ! They are down to earth and there is no hierarchical setup but indeed they provide one to one coaching.",
  },
  {
    name: "Lolitha Maruthi",
    image: TestimonialImageThree,
    content:
      "Best faculty here and mainly Ashwini Sir and Deepshikha Madam are very humble and excellent teacher with best teaching skills.My brother has taken addmission here and he was very satisfied with faculties and teaching atmosphere.",
  },
  {
    name: "Snehan Singha",
    image: TestimonialImageOne,
    content:
      "Easily explaining all the points and they behaving like home people, they solve the problems about studying, finally good teaching mam and Sir Thank you so much Mam and Sir 🙏🙏🙏",
  },
  {
    name: "parents",
  ...
  },
  {
    ...
    content:
      "Mr. Ashwin kumar is a great teacher and his teaching skills are of next level. he explain the topic in very simple and concise way. I think chosing this tution for my son has been the great decision.",
  },
  {
    name: "Kuberan's Mother",
    image: TestimonialImageEight,
    content:
      "Very Good Tution centre.... Best Coaching and Wonderful Tutors.... Will give single attention to each students with care.... My son's showed wonderful improvements in their academics....",
  },
  {
    name: "Malthesh Father",
    image: TestimonialImageNine,
    content:
      "Very good tuition,Mr. Ashwin is a phenomenal teacher. i can feel a lots of improvement in my sons academics. Very special this about this tution is that they provide the one to one class to each student. They expalain the topic in very effective way.",
  },
  {
    name: "Mithesh Kumar",
